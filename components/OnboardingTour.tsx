...
const ONBOARDING_STEPS: OnboardingStep[] = [
  {
    ...
    icon: <Image source={require('@/assets/images/logotitle.png')} style={{ width: 96, height: 96 }} resizeMode="contain" />,
        ...
        <View style={[styles.content, { width: Math.min(width * 0.9, 400), maxHeight: height * 0.8 }]}>
          ...
          >
            <View style={styles.iconContainer}>
              {step.icon || <Image source={require('@/assets/images/logotitle.png')} style={{ width: 96, height: 96 }} resizeMode="contain" />}
            </View>
