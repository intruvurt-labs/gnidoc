...
export default function AboutScreen() {
  ...
  const handleContactPress = async () => {
    try {
      const supported = await Linking.canOpenURL('mailto:support@intruvurt.space');
      if (supported) {
        await Linking.openURL('mailto:support@intruvurt.space?subject=gnidoC%20Terces%20Support%20Request&body=Hello%20Support%20Team%2C%0A%0AI%20need%20help%20with%3A%0A%0A');
      } else {
        console.log('[About] Email client not available');
      }
    } catch (error) {
      console.error('[About] Failed to open email client:', error);
    }
  };
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.appSection}>
          ...
          <Text style={styles.description}>
            A professional mobile development environment powered by AI. Build, analyze, and deploy 
            React Native applications with advanced code generation, real-time analysis, and 
        ...
        <View style={styles.section}>
          ...
          <View style={styles.companyCard}>
            ...
            <Text style={styles.companyDescription}>
              Leading development and holdings company specializing in blockchain technology, 
              cloud infrastructure, and advanced web applications.
            </Text>
            <TouchableOpacity 
        ...
        <View style={styles.legalSection}>
          <Text style={styles.legalText}>
            © 2024 Intruvurt Holdings. All rights reserved.
          </Text>
          <Text style={styles.legalText}>
