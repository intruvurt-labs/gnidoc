...
export const gnidocTercesPhases = [
  ...
  'Reverse the Threat. Rewrite the Future.',
  'Neural Defense: Always Learning.',
  'Unbreakable. Untraceable. Unstoppable.',
  'When AI Hunts Hackers.',
  'Quantum-Secured. Human-Inspired.',
  'Zero Trust. Infinite Intelligence.',
  'Autonomous Security. No Sleep Required.',
  'AI Firewalls with a Mind of Their Own.',
  'RATSCan: No Threat Survives Inspection.',
  'Build. Encrypt. Deploy.',
  'gnidoC TerceS: The Future.',
  'Not One AI. A Collective Consciousness.',
  'very Model Has a Mission.',
  'Dual-Core Thinking. Singular Execution.',
  'The Only Builder That Builds Itself.',
  'Gnidoc-Terces: Where Prompts Become Power.',
  'Fusion Intelligence: Where Models Collide and Create.',
  'Built by Code. Refined by Thought.',
  'Your Ideas, Reverse-Engineered into Reality.',
  'Multi-Model Minds. Single Vision.',
  'AI That Codes, Tests, and Evolves — Like a Team Should.',
